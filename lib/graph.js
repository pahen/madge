 ...
 * @return {Promise}
 */
export const svg = function (modules, circular, config) {
 ...
 * @return {Promise}
 */
export const image = function (modules, circular, imagePath, config) {
	const options = createGraphvizOptions(config);
 ...
 * @return {Promise}
 */
export const dot = function (modules, circular, config) {
	const options = createGraphvizOptions(config);
